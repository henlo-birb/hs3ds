...
TITLE_LIMIT = 20
top_dims = {love.graphics.getDimensions("top")}
bottom_dims = {love.graphics.getDimensions("bottom")}
courier = love.graphics.newFont("courier.bcfnt")
default_font = love.graphics.getFont()
top_view = {
    Rectangle(0, 0, top_dims[1], top_dims[2], {0.77647, 0.77647, 0.77647}), {
        ...
        {0.933, 0.933, 0.933}), {}},
        {
            ...
            function() return app.model.current_page.title_len > TITLE_LIMIT and top_dims[1] * .75 or top_dims[1] / 2 end,
            "center"
            ) + {
...
bottom_view = {
    Rectangle(0, 0, bottom_dims[1], bottom_dims[2], {0.933, 0.933, 0.933}), {
        {
        ...
        },
        {
            ...
            function(this) return bottom_dims[2] - this.y end,
            function() return app.model.text_delta_scroll * app.model.scroll_multiplier end
                ...
                force_scroll = function(this)
                    ...
                    return next_button and getY(next_button) + next_button.rect_height + this.total_scroll_y > bottom_dims[2]
                end
            }, {}
        }
    }
