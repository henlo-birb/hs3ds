...
local function renderAnimation(this, app)
    ...
    if newName ~= this.oldName then
        ...
        local anim = AnimationData[newName]
        this.nFrames = anim.nFrames
        this.currentFrame = 1

        this.nAtlases = anim.nAtlases
        this.quads = {}
...
local function renderButton(this, app)
    ...
    this.isPressed = app.model.touching and
                         (app.model.touchpos.x > x and app.model.touchpos.x <
                             x + rectWidth) and
                         (app.model.touchpos.y > y and app.model.touchpos.y <
                             y + rectHeight)
